 ...
 * @author gabriel
 */
public class PlacaMae extends ComponenteComposto{

    public PlacaMae(double precoInicial) {
        super(precoInicial);
    }
    ...
    public String descricao() {
        if(this.getElementos().isEmpty()){
            return "Uma placa mãe que não possui componentes. Seu valor é de: "+ this.getPreco();
        }
     
        String descricao = "Uma placa mãe de valor: "+ this.getPrecoIndividual() +" que contém: \n";
