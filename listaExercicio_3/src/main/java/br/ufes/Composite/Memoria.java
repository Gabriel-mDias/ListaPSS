 ...
 * @author gabriel
 */
public class Memoria extends ComponenteComposto{

    public Memoria(double precoInicial) {
        super(precoInicial);
    }
    ...
    public String descricao() {
        if(this.getElementos().isEmpty()){
            return "Uma memória que não possui componentes. Seu valor é de: "+ this.getPreco();
        }
     
        String descricao = "Uma memória de valor: "+ this.getPrecoIndividual() +" que contém: \n";
